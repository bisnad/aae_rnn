...
mocap_file_path = "D:/Data/mocap/muriel_athens_xsens_awinda_april_2023/"
mocap_files = ["MurielDancing-005.bvh"]

mocap_valid_frame_ranges = [ [ 50, 6400 ] ]
...
def ae_loss(y, yhat, disc_fake_output):
    ...
    # discrimination loss
    _fake_loss = cross_entropy(torch.ones_like(disc_fake_output), disc_fake_output)
...
def create_2d_latent_space_representation(sequence_excerpts):
    ...
    for eI in range(0, excerpt_count, batch_size):
        ...
        encoding_batch = encoder(excerpt_batch)   
